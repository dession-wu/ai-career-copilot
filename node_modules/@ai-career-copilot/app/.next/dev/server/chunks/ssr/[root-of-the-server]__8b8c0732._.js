...
"[project]/app/src/app/[locale]/(auth)/register/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (password !== confirmPassword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(t('auth.passwordMismatch') || "两次密码输入不一致");
            return;
        }
        setIsLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("/api/auth/register", {
                username,
                email,
                password
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(t('auth.registerSuccess') || "注册成功");
            router.push("/login");
        } catch (err) {
            const error = err;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.detail || t('auth.registerFailed') || "注册失败");
        } finally{
            setIsLoading(false);
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8b8c0732._.js.map