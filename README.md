...
| 时间 | 功能模块 | 展示内容 |
|------|---------|---------|
| 0:00-0:05 | 首页 | 项目介绍、响应式界面 |
| 0:05-0:15 | 用户系统 | 注册、登录流程 |
| 0:15-0:25 | 经历总库 | 简历上传、AI解析、结构化展示 |
| 0:25-0:35 | 求职管理 | 投递跟踪、状态管理 |
| 0:35-0:42 | 简历定制 | AI匹配分析、定制生成 |
| 0:42-0:48 | 面试准备 | 题目生成、STAR建议 |

### 在线体验

🌐 **在线 Demo**: [https://my-career-copilot.vercel.app](https://my-career-copilot.vercel.app)
