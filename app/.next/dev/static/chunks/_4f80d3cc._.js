...
"[project]/app/src/app/[locale]/(auth)/login/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/api/auth/login", formData.toString(), {
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded"
                }
            });
            localStorage.setItem("token", response.data.access_token);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t("auth.loginSuccess") || "登录成功");
            router.push("/dashboard");
        } catch (err) {
            const error = err;
...
_s(LoginPage, "UEfkkjocHYzGT0cenohh9ly1txY=", false, function() {
    return [
...
//# sourceMappingURL=_4f80d3cc._.js.map